package com.y271727uy.pomegranate.data;
...
public final class PomegranateData {
    ...
    private static final String CFG_EAT_WHEN_FULL_ENABLED = "EatingWhenFullEnabled";
    private static final String CFG_FULL_HUNGER_MODE = "FullHungerMode";
    private static final String CFG_FULL_HUNGER_ITEM_LIST = "FullHungerItemList";
    private static final String CFG_UNEATABLE_WHEN_FULL_ITEMS = "UneatableWhenFullItems";
    ...
    public static CompoundTag toClientTag(Player player) {
        ...
        out.putBoolean(CFG_EAT_WHEN_FULL_ENABLED, PomegranateConfig.enableEatingWhenFull());
        out.putString(CFG_FULL_HUNGER_MODE, PomegranateConfig.getFullHungerMode().name());
        out.put(CFG_FULL_HUNGER_ITEM_LIST, stringList(PomegranateConfig.getFullHungerItemList()));
        out.put(CFG_UNEATABLE_WHEN_FULL_ITEMS, stringList(PomegranateConfig.getUneatableWhenFullItems()));
